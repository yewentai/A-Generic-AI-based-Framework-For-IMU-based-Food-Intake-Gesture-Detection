...
"""
================================================================================================
MSTCN Right Hand IMU Training Script
------------------------------------------------------------------------------------------------
Author      : Joseph Yep
Email       : yewentai126@gmail.com
Edited      : 2025-04-14
Description : This script trains an MSTCN model on RIGHT hand IMU data using cross-validation.
================================================================================================
"""
...
# ==============================================================================================
#                            Main Training Code (Right Hand)
# ==============================================================================================

parser = argparse.ArgumentParser(description="Right Hand IMU Training Script")
...
if local_rank == 0:
    ...
    logger.info(f"Right Hand Training started at: {overall_start}")
    version_prefix = datetime.now().strftime("%Y%m%d%H%M")[:12] + "_RIGHT"
...
if local_rank == 0:
    ...
    logger.info(f"Right hand training statistics saved to {training_stats_file}")
    ...
    logger.info(f"Right hand configuration saved to {config_file}")
