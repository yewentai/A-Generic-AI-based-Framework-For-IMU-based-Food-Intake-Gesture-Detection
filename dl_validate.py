...
"""
===============================================================================
MSTCN IMU Validating Script (Optimized for Three Validation Modes)
-------------------------------------------------------------------------------
Author      : Joseph Yep
Edited      : 2025-04-14
...
if __name__ == "__main__":
    ...
    for version in versions:
        ...
        for mode in validation_modes:
            ...
            # Save all statistics
            stats_file_npy = os.path.join(result_dir, "validate_stats.npy")
            stats_file_json = os.path.join(result_dir, "validate_stats.json")
